...
If [`OUTPUT_STORAGE_BUCKET`](https://github.com/pdfplum/pdfplum/PREINSTALL.md#outputstoragebucket-optional) extension parameter is set, you need to allow writes to where generated PDF files are going to be stored at:
